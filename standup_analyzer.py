...
def analyze_weekly_data():
    ...
    try:
        ...
        prompt = f"What are the areas of improvement for each employee individually to perform better based on the following Daily standup meeting events be gender netural:\n{data}\n"
